import secPage from "../Assets/SpaceX.mp4";
import thirdPage from "../Assets/second.jpg";
import fourthPage from "../Assets/SpaceX3.mp4";
import fifthPage from "../Assets/fourth.jpg";
import sixthPage from "../Assets/SpaceX5.mp4";
import PageIterator from "./utilities/PageIterator";
...
const ComponentData = () => {
  ...
  return (
    <>
      <PageIterator data={arrOfData}></PageIterator>
    </>
  );
};
